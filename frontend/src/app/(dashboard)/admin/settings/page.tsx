...
//         if (!window.confirm('Are you sure you want to delete this test and all its attempts? This action cannot be undone.')) {
//             return;
//         }
//         const token = localStorage.getItem('authToken');
//         try {
//             const res = await fetch(`http://localhost:5000/api/admin/tests/${testId}`, {
//                 method: 'DELETE',
//                 headers: { 'Authorization': `Bearer ${token}` },
//             });
...
//                             <tbody>
//                                 {tests.map(test => (
//                                     <tr key={test._id} className="border-b border-gray-800 hover:bg-gray-800">
...
//                                         <td className="p-4">
//                                             <button onClick={() => handleDelete(test._id)} className="text-red-500 hover:text-red-400 font-semibold">
//                                                 Delete
//                                             </button>
//                                         </td>
//                                     </tr>
...
//     const handleDelete = async (testId: string) => {
//         if (!confirm('Are you sure you want to delete this test and all its attempts? This action cannot be undone.')) {
//             return;
//         }
//         const token = localStorage.getItem('token');
//         try {
