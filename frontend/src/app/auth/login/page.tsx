...
//     return (
//         <div className="flex items-center justify-center min-h-screen bg-gray-900 font-sans p-4 bg-gradient-to-br from-gray-900 via-black to-gray-900">
//             <div className="w-full max-w-md mx-auto">
//                 <div className="bg-black/50 border border-cyan-800/50 rounded-2xl shadow-2xl shadow-black/40 p-8 space-y-8 backdrop-blur-xl">
                    
//                     <div className="text-center">
//                         <h1 className="text-3xl font-bold text-white tracking-tight flex items-center justify-center space-x-2">
//                            <span className="bg-cyan-500 w-3 h-3 rounded-full inline-block"></span>
...
//                                     value={email}
//                                     onChange={(e) => setEmail(e.target.value)}
//                                     className="w-full pl-10 bg-gray-900/50 border border-gray-700 text-gray-100 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-all duration-300"
//                                     required
//                                 />
//                             </div>
//                         </div>
...
//                                 <p><span className="font-bold">Login Failed:</span> {error}</p>
//                             </div>
//                         )}
...
//                             type='submit' 
//                             disabled={isLoading}
//                             className="w-full flex items-center justify-center bg-cyan-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:bg-gray-700 disabled:text-gray-400 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
//                         >
